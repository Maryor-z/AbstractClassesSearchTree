...
public class SearchTree implements NodeList{
    ...
    public boolean addItem(ListItem newItem) {
        if (this.root == null) {
//            this tree is empty so this item becomes the head of the tree
            this.root = newItem;
            return true;
        }
    ...
    private void performRemoval(ListItem item, ListItem parent) {
        ...
        if (item.next() == null) {
            ...
            if (parent.next() == item) {
                ...
                // item is legt child of its parent
            ...
            // neighbor left nor right are null, deletion is now a lot trickier!
